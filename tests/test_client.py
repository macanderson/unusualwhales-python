...
from unusualwhales import Unusualwhales, AsyncUnusualwhales, APIResponseValidationError
...
def _get_open_connections(client: Unusualwhales | AsyncUnusualwhales) -> int:
...
class TestUnusualwhales:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "unusualwhales/_legacy_response.py",
                        "unusualwhales/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "unusualwhales/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: Unusualwhales) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(UNUSUALWHALES_BASE_URL="http://localhost:5000/from/env"):
            client = Unusualwhales(api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: Unusualwhales) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Unusualwhales) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Unusualwhales) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Unusualwhales(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Unusualwhales(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_omit_retry_count_header(
        self, client: Unusualwhales, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncUnusualwhales:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncUnusualwhales) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(UNUSUALWHALES_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncUnusualwhales(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncUnusualwhales) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncUnusualwhales) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncUnusualwhales) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncUnusualwhales(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncUnusualwhales(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncUnusualwhales,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncUnusualwhales, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
